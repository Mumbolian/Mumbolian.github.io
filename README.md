...
- **Automatic updates** (v1.11+): The app automatically checks for new versions and refreshes when updates are available. Checks run when you return to the tab (focus event)—battery-friendly and non-intrusive. Your settings are preserved through updates via localStorage.
